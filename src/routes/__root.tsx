...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Madras Engineering College" },
      { property: "og:title", content: "Game Development Workshop | Madras Engineering College" },
      { property: "og:description", content: "Enter the world of game development at Madras Engineering College on 25 September 2026." },
